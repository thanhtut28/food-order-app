/*
  ...
  - You are about to drop the `IngreidentOnItem` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "IngreidentOnItem" DROP CONSTRAINT "IngreidentOnItem_ingredientId_fkey";

-- DropForeignKey
ALTER TABLE "IngreidentOnItem" DROP CONSTRAINT "IngreidentOnItem_menuItemId_fkey";

-- DropTable
DROP TABLE "IngreidentOnItem";
